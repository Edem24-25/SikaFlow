...
<section class="max-w-2xl mx-auto px-4 py-10">
  <h1 class="text-2xl font-bold mb-6">Nouvel abonnement</h1>
  <form method="POST" action="{{ route('abonnements.store') }}" class="bg-white p-6 rounded-2xl shadow-soft border border-slate-100 space-y-4">@csrf
    ...
    <button class="w-full py-2.5 rounded-lg bg-sika-600 text-white font-semibold hover:bg-sika-700">Enregistrer</button>
  </form>
</section>
@endsection
