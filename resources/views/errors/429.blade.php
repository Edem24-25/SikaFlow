...
<head>
    ...
    <title>Trop de requêtes — SikaFlow</title>
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex items-center justify-center antialiased">
    <div class="text-center px-4">
        ...
        <h1 class="text-7xl font-extrabold text-orange-500 mb-4">429</h1>
        <h2 class="text-2xl font-bold text-night-900 mb-3">Trop de requêtes</h2>
        <p class="text-slate-500 mb-8 max-w-md mx-auto">Vous avez effectué trop de requêtes en peu de temps. Veuillez patienter quelques instants avant de réessayer.</p>
