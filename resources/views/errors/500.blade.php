...
<head>
    ...
    <title>Erreur serveur — SikaFlow</title>
...
<body class="bg-slate-50 text-slate-800 min-h-screen flex items-center justify-center antialiased">
    <div class="text-center px-4">
        ...
        <h1 class="text-7xl font-extrabold text-rose-500 mb-4">500</h1>
        <h2 class="text-2xl font-bold text-night-900 mb-3">Erreur serveur</h2>
        <p class="text-slate-500 mb-8 max-w-md mx-auto">Quelque chose s'est mal passé de notre côté. Réessayez dans quelques instants ou contactez le support.</p>
