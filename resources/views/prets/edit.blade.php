...
<section class="max-w-3xl mx-auto px-4 py-10">
  <h1 class="text-2xl font-bold mb-6">Modifier le prêt {{ $pret->reference }}</h1>
  <form method="POST" action="{{ route('prets.update', $pret) }}" class="bg-white p-6 rounded-2xl shadow-soft border border-slate-100 space-y-4">
    @csrf @method('PUT')
